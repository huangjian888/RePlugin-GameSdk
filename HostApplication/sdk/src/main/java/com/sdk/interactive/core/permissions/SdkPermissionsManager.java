 ...
 *
 */
public class SdkPermissionsManager {
    private final String TAG = "SdkPermissionsManager";

    private final Object mObject;
    private final SdkPermissionsCallbacks mPermissionsCallbacks;
     ...
     * @param permissionsCallbacks      监视用户提供权限的事件
     ...
     */
    SdkPermissionsManager(
            Object object,
            SdkPermissionsCallbacks permissionsCallbacks,
...
//            return ((android.app.Fragment) object).shouldShowRequestPermissionRationale(perm);  //23中才会有shouldShowRequestPermissionRationale
            return false;
        } else {
            return false;
        }
...
//            ((android.app.Fragment) object).requestPermissions(perms, requestCode);
    ...
    /*public static final class Builder {
        ...
        public Builder onFuncellPermissionsCallbacks(SdkPermissionsCallbacks funcellPermissionsCallbacks){
